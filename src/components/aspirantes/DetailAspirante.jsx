...
import { getAspiranteById, updateAspirante } from "../servicios/aspirantesService";
...
function AspiranteDetail() {
  ...
  //                 console.log(`Aspirante: ${aspirante.nombre}, Profesión: ${aspirante.profesion}`);
  //             });
  ...
  const handleFormSubmit = (e) => {
    ...
    // Call the updateAspirante function from your service
